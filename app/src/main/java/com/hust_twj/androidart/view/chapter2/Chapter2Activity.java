package com.hust_twj.androidart.view.chapter2;
    ...
    private void bindListener() {
        findViewById(R.id.tv_dialog).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                AlertDialog dialog = new AlertDialog.Builder(Chapter2Activity.this, R.style.Theme_AppCompat_DayNight_Dialog_Alert)
                        .setMessage("确定要清除数据吗？")
